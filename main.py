...
indices,data=ObjLoader.load_model("./data/rocket.obj")
...
look_mat=pyrr.matrix44.create_look_at(pyrr.Vector3([-25,1.5,0]),pyrr.Vector3([0,0,0]),pyrr.Vector3([0,1,0]))
